...
We say a polynomial has degree $$n$$ if $$x^{n}$$ is the largest power of $$x$$ that has a non-zero coefficent. 
...
![](/assets/Screen Shot 2018-03-13 at 11.00.01 PM.png = 250x)
...
a(2)^4 + b(2)^3 + c(2)^2 + d(2) + e = -11\\
a(3)^4 + b(3)^3 + c(3)^2 + d(3) + e = 2\\
a(4)^4 + b(4)^3 + c(4)^2 + d(4) + e = 99
$$
