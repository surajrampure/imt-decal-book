...
- $$5^{11} \\: (\text{mod} \\: 26) \equiv (5^2)^5\cdot 5 \equiv 1^5 \cdot 5 \equiv 5 \\: (\text{mod} \\: 26)$$
- $$23^9 \\: (\text{mod} \\: 24) \equiv (-1)^9 \equiv -1 \equiv 22 \\: (\text{mod} \\: 24) $$
...
$$\begin{align*} 4^1 &\equiv 4 \\: (\text{mod} \\: 13) \\\ 4^2 \equiv 16 &\equiv 3 \\: (\text{mod} \\: 13) \\\ 4^8 \equiv (4^2)^4 \equiv 3^4 \equiv 81 &\equiv 4 \\: (\text{mod} \\: 13) \\\ 4^{16} \equiv (4^8)^2 \equiv 4^2 \equiv 16 &\equiv 3  \\: (\text{mod} \\: 13) \end{align*}$$
...
$$\begin{align*} 4^{26} &\equiv 4^{16} \cdot 4^{8} \cdot 4^2 \\\ &\equiv 3 \cdot 4 \cdot 3 \\\ &\equiv 12 \cdot 3 \equiv (-1) \cdot 3 \\\ &\equiv 10 \\: (\text{mod} \\: 13) \end{align*} $$
