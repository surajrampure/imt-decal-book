...
Suppose we want to show that $$x^2 \text{ is even} \implies x \text{ is even}$$, i.e. that $$(x^2 \text{ is odd} \vee x \text{ is even})$$ always holds a true value. The negation of this looks like $$x^2 \text{ is even} \wedge x \text{ is odd}$$. 
