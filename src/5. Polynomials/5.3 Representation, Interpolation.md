<title>5.3: Representation of Polynomials – Polynomials</title>

# 5.3: Representation of Polynomials, Interpolation
---
...
The degree of a polynomial defines several of its key features, which we will now investigate.
