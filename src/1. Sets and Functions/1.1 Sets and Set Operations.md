...
In this section, we will look at the formal definition of a set, a subset, and identify various operations that act on multiple sets. We also introduce the idea of the universal set and a complement. One notable omission is any discussion on the size of a set; this idea will be briefly introduced in later sections, but studied further when we discuss combinatorics. 

<br>

<div align=center>

<iframe width="560" height="315" src="https://www.youtube.com/embed/W3ErPbwL6A4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/5BP2o-e6L1w" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
> ### Definition:  **Cartesian Product** </a>
...
In our case, the complement of $$A$$ (denoted $$A'$$, $$A^{c}$$ or $$\bar{A}$$) is $$A^c = \\{3, 5, 6, 7, 9\\}$$.
...
De Morgan's Laws allow us to convert from a union to an intersection, and vice versa. We leave the proof as an exercise (for those following along in the course, this will be a problem on the corresponding problem set).
