...
- the numbers $$\frac{4}{3}$$, $$\frac{8}{6}$$, $$\frac{12}{9}$$, etc. all represent the same number – in order to have duplicates in our domain, we only count the first valid occurrence of each rational number

Then, our injectio $$\mathbb{N} \rightarrow \mathbb{Q}$$ looks something like this:
