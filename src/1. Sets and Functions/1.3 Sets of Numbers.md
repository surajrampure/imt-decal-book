...
The next relevant set of numbers is the set of complex numbers. However, their discussion isn't important right now, but feel free to read [1.4 Complex Numbers](1.4 Complex Numbers.md) if you are interested.
